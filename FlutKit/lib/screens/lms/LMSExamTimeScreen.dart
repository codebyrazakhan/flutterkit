...
class LMSExamTimeScreen extends StatefulWidget {
  @override
  _LMSExamTimeScreenState createState() => _LMSExamTimeScreenState();
}

class _LMSExamTimeScreenState extends State<LMSExamTimeScreen> {
  ThemeData themeData;
