...
import 'package:UIKit/screens/social/SocialPostScreen.dart';
...
class _SocialHomeScreenState extends State<SocialHomeScreen> {
                      ...
                      child: Row(
                        children: [
                          ...
                          statusWidget(
                              ...
                              isLive: true),
                          statusWidget(
                              image: './assets/images/avatar-1.jpg', type: 1),
                          statusWidget(
                              image: './assets/images/avatar-2.jpg', type: 1),
                          statusWidget(
                              image: './assets/images/avatar-5.jpg', type: 2),
                          statusWidget(
                    ...
                    child: Column(
                      children: [
                        postWidget(
                            ...
                            postImage: './assets/images/profile-banner.jpg',
                            likes: "21 Like this",
                            time: '12 min'),
                        Divider(
                          height: 0,
                        ...
                        postWidget(
                            ...
                            name: "Google",
                            status: "Sponsored",
                            postImage: './assets/images/social/post-1.jpg',
                        ...
                        postWidget(
                            ...
                            postImage: './assets/images/social/post-l1.jpg',
  ...
  Widget statusWidget(
      {String image, int type = 1, bool isLive = false, bool isMuted = false}) {
    return Opacity(
      opacity: isMuted ? 0.4 : 1,
      child: InkWell(
        onTap: (){
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => SocialStatusScreen()));
        },
        child: Container(
  ...
  Widget postWidget(
    ...
    return InkWell(
      onTap: (){
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => SocialPostScreen()));
      },
      child: Container(
              ...
              child: Row(
                ...
                children: [
                  InkWell(
                    onTap: (){
                      Navigator.push(
                          context, MaterialPageRoute(builder: (context) => SocialProfileScreen()));
                    },
                    child: Container(
                      child: ClipRRect(
                          borderRadius:
